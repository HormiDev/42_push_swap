...
#    Updated: 2024/06/18 18:45:15 by ide-dieg         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
test: test1 test2 test3 test4 test6 test7 test8 test9 test10 test11 test12 test13 test14 test15 test16 test17 test18 test19

test1:
	@echo "test 1"
	@echo parámetros no numéricos
	@if [ "$$(./$(NAME) $(ARGS1))" = "Error" ]; then \
