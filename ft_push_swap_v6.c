...
void	ft_move_to_a_v6(t_push_swap *push_swap, t_instructions *instructions)
{
	t_stack	*min;
	t_stack	*max;
	int		min_position;
...
t_instructions	*ft_move_to_b_v6(t_push_swap *push_swap, int range)
{
